...
const config = {
  github: {
    ...
    exclude: {
      ...
      projects: ['emretemirdev','programming-2-homework-for-my-college','labapp','emretemir.github.io'], // These projects will not be displayed. example: ['my-project1', 'my-project2']
    },
  },
  social: {
    linkedin: 'emretemirr',
